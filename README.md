...
| **Shoot the Moon** | Rarity: Common → **Uncommon**. **Reworked:** after each played hand, permanently gains **+13** Mult for each **Queen** held in hand at scoring time; that total is added as Mult during `joker_main`. |
...
- **Author:** joelmforsyth  
- **Version:** 1.0.0 (see `Supercharged.json`)
